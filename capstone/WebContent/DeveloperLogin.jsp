...
<body>
	<div class="nav">
	   <div class="w3-bar w3-black w3-card w3-left-align w3-large">
		  ...
		  <a href="contact.jsp" class="w3-bar-item w3-button w3-padding-large w3-hover-white" style="left: 725px;position:relative;">Contact</a>
    ...
    <div class="sidenav">
         <div class="login-main-text">
            <h2>Application<br>Developer Login Page</h2>
      ...
      <div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form">
               <form class="text-center" id="form" name="form" method="get" action="Devlogin">
