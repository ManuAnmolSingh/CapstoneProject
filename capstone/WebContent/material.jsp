...
<head>
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/admin/1-4-6/css/style.default.css" id="theme-stylesheet"><link id="new-stylesheet" rel="stylesheet">
            ...
            <div class="container-fluid">
              <div class="row bg-dark has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center bg-dark">
                    ...
                    <div class="number"><strong><%=Countrow%></strong>
                    </div>
                  </div>
                </div>
                <!-- Item -->
